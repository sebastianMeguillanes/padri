                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <div class="header">
                                        <h2><strong>Roles</strong> de acceso</h2>
                                ...
                                <div class="card-body" id="listadoregistros">
                                    ...
                                    <div class="card-body" id="formularioregistros">
                                        <form name="formulario" id="formulario" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Nombre del Rol</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="row mb-3">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Permisos</label>
                                                <div class="col-sm-10">
                                                    <select id="permiso" name="permisos[]" class="form-control" tabindex="-1" multiple style="display: none; width: 100%" required></select>
                                                </div>
                                            </div>                        
...
<script type="text/javascript" src="script/rol.js"></script>  